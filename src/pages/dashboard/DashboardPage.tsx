import { IoAccessibilityOutline, IoHeartOutline, 
  // IoInformationOutline, 
  IoListOutline, IoLockClosedOutline, IoPawOutline } from 'react-icons/io5';
import { 
  // RequestInfo, 
  WhiteCard } from '../../components';
...
export const Dashboard = () => {
  ...
  const totalTasks = useTaskStore( state =>  state.tasks);
  const tasksCount = Object.keys(totalTasks).length
  return (
    <>
      <h1>Dashboard</h1>
